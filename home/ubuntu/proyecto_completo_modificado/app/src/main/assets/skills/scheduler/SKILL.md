...
The `instruction` is the command the sub-agent will execute. Write it as if you were giving Doey the command directly. The sub-agent has access to all tools (SMS, HTTP, TTS, beep, Intent, etc.).
