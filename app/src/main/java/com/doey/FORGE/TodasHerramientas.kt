...
import com.doey.DELTA.comun.MemoryEntry
import com.doey.DELTA.comun.parseMemoryEntries
import com.doey.DELTA.comun.toJson
    ...
    override suspend fun execute(args: Map<String, Any?>): ToolResult {
        ...
        return when (action) {
            "get_tree"   -> withContext(Dispatchers.Main) {
                ...
                val compressed = com.doey.NEXUS.TokenOptimizer.compressAccessibilityTree(
